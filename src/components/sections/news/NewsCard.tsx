...
export function NewsCard({ article, featured, index }: NewsCardProps) {
  ...
  return (
    ...
    >
      <Link 
        to={`/${lang}/news/${article.slug}`} 
        className={`group flex flex-col bg-white rounded-3xl overflow-hidden border border-mist shadow-sm hover:shadow-md transition-shadow duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 block 

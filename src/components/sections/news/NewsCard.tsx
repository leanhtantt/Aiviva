...
export function NewsCard({ article, featured, index }: NewsCardProps) {
  ...
  return (
    <motion.article 
      ...
      `}
    >
      <Link to={`/${lang}/news/${article.slug}`} className={`contents focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-3xl`}>

export const homeContentEn = {
  ...
  problem: {
    ...
    cta: "AIVIVA solves all of these ↓"
  },
  howItWorks: {
    ...
    steps: [
      {
        title: "Open camera",
        desc: "Any phone, tablet, or laptop"
      },
      {
        title: "AI analyzes",
        desc: "Micro color changes in facial blood flow"
      },
      {
        title: "Processed on-device",
        desc: "No facial image stored, GDPR compliant"
      },
      {
        title: "Get results",
  ...
  features: {
    headline: "Why AIVIVA?",
    subheadline: "Faster. Cheaper. More private than any medical device.",
    items: [
      {
        title: "No device needed",
        desc: "Use the phone you already have"
      },
      {
        title: "30 seconds",
        desc: "For 5 full vital signs"
      },
      {
        title: "$0 to start",
        desc: "Your health at your fingertips"
      },
      {
        title: "Edge AI",
        desc: "Data never leaves your device, fully GDPR compliant"
      }
    ]
  },
  trust: {
